  ...
  return (
    <main style={styles.page}>
      ...
      <section style={styles.statsGrid}>
        <StatCard label="Total squares games" value={games.length} />
                ...
                <div style={styles.cardTop}>
                  ...
                  <div style={styles.cardMain}>
                    <div style={styles.cardHeader}>
                      ...
                      <span style={{ ...styles.status, ...getStatusStyle(game.status) }}>
                        {game.status}
                      </span>
                    </div>

                    <div style={styles.detailGrid}>
                      <Detail label="Price" value={formatMoney(game.price_per_square_cents, game.currency)} />
                    ...
                    <div style={styles.actions}>
                      <Link href={`/admin/squares/${game.id}`} style={styles.openButton}>
                        Open details
                      </Link>

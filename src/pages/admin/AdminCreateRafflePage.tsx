...
export default function AdminCreateRafflePage() {
  ...
  function addTemplateOffer(template: { label: string; quantity: number; price: number }) {
    setOffers((prev) => [
      ...prev,
      { id: uid(), label: template.label, quantity: template.quantity, price: template.price },
    ]);
  }
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    alert("Admin create page upgraded. Next step is wiring this to your API/database.");
  }
      ...
      <form onSubmit={handleSubmit}>
        <div style={topBarStyle}>
          <div>
            ...
            <h1 style={pageTitleStyle}>Create raffle</h1>
            <p style={pageSubtitleStyle}>
              Build the raffle, pricing, offers, colours and public-facing preview.
            </p>
          </div>
        ...
        <div style={layoutStyle}>
                    ...
                    return (
                      <div key={offer.id} style={offerCardStyle}>
                        <div style={offerGridStyle}>
                          ...
                          <Field label="Quantity">
                            <input
                              ...
                              onChange={(e) =>
                                updateOffer(offer.id, "quantity", Number(e.target.value))
                              }
                              style={inputStyle}
                            />
                          </Field>
                          ...
                          <Field label="Price (£)">
                            <input
                              ...
                              value={offer.price}
                              onChange={(e) =>
                                updateOffer(offer.id, "price", Number(e.target.value))
                              }
                              style={inputStyle}
                            />
                          </Field>
                        ...
                        <div style={offerMetaStyle}>
                          ...
                          <span>
                            vs base £{money(ticketPrice)} each
                          </span>
                        </div>
                      </div>
                    );
          ...
          <div style={rightColumnStyle}>
            ...
            >
              <div style={previewCardStyle}>
                ...
                <div style={previewBodyStyle}>
                  ...
                  <div style={{ marginTop: 18 }}>
                    <div style={previewSectionTitleStyle}>Number selection preview</div>
            ...
            <SectionCard title="Pricing insight" subtitle="Quick commercial summary." sticky={false}>
              <div style={{ display: "grid", gap: 12 }}>
                <InsightRow
